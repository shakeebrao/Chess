public class Rook extends Board{
    ...
    void movePiece(int pos, String color, int row) {
        ...
        if(this.row == row && this.column != pos){
        ...
        if(moved){
            ...
            throw new IllegalArgumentException("Rook must move in a straight line");
        }
    }
    @Override
